...
with lib;
{
  options.macos.manageApps = lib.mkOption {
    type = types.bool;
    default = false;
    description = "Manages the ~/Applications directory, automatically aliasing .app bundles";
  };

  config.home.activation =
    let
      isEnabled = config.macos.manageApps;
    in
    {
